      ...
      <div className="container py-5">
        <div className="row g-5">
          <div className="col-lg-3 col-md-6">
            <h4 className="text-light mb-4">About GCS Logistics</h4>
            <p>GCS Logistics delivers end-to-end transportation, shipping, and warehousing solutions with a strong network, technology-driven operations, and a skilled team.</p>
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <Link className="btn btn-link" style={{fontSize: '15px'}} to="">Terms & Condition</Link>
            <Link className="btn btn-link" style={{fontSize: '15px'}} to="">Support</Link>
          </div>
          <div className="col-lg-3 col-md-6">
          ...
          <div className="col-lg-3 col-md-6">
            ...
            <p className="mb-2" style={{fontSize: '15px'}}><i className="fa fa-phone-alt me-3"></i>+91 9876543210</p>
